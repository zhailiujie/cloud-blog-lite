...
远程 D1 创建 users/categories/sites/tags/site_tags/settings/operation_logs 等表，并补齐 sites 的置顶、点击统计字段
```
...
如果修改了 D1 migration，或包含依赖新字段/新表的功能（如站点置顶、点击统计、标签筛选、站点导入导出）：
